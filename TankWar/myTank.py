...
class MyTank(pygame.sprite.Sprite):
    def __init__(self, playerNumber):
        ...
        self.life = 3  # 坦克生命
        self.bulletNotCooling = True  # 子弹冷却
    ...
    # 返回True 代表发生碰撞
    # 碰撞检测并移动
    def moveUp(self, tankGroup, brickGroup, ironGroup, riverGroup) -> bool:
    ...
    def moveDown(self, tankGroup, brickGroup, ironGroup, riverGroup) -> bool:
        self.rect = self.rect.move(self.speed * 0, self.speed * 1)
    ...
    def moveLeft(self, tankGroup, brickGroup, ironGroup, riverGroup) -> bool:
    ...
    def moveRight(self, tankGroup, brickGroup, ironGroup, riverGroup) -> bool:
        self.rect = self.rect.move(self.speed * 1, self.speed * 0)
